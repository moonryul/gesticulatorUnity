...
# full_speech_enc_dim: 612
            ...
            if use_conditioning:
                ...
                if self.hparams.n_prev_poses == 3:
                    pose_condition_info = torch.cat((prev_poses[-1], prev_poses[-2],
                                                     prev_poses[-3]), 1)
                  #MJ: Three previous poses were encoded into a 512-dimensional conditioning vector
    ...
    def FiLM(self, conditioning, nn_layer, hidden_size, use_conditioning):
        ...
        Args:
            conditioning:     a vector of conditioning information
               #MJ:==  a 512-dimensional conditioning vector which was composed of three previous poses
 ...
 # Each training sequence contains 70 consecutive frames from a larger recording.
